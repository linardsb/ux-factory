...
The agent exposes **3 consolidated tools** following Anthropic's best practices. See [mvp-tool-designs.md](./reference/mvp-tool-designs.md) for detailed specifications.
...
### Related Documents
- [MVP Tool Designs](./reference/mvp-tool-designs.md) - Detailed tool specifications
