...
// spine package carries a `posture` field the README does not document, and facets / endedAt /
...
export function checkOpLines(lines) {
  ...
  // seq stays tolerated ON PURPOSE — renderDecision's "not in this ledger" path is deliberate, and
