...
tooling/
  build-checks.mjs            37 PURE groups, in CI — the repo's main gate  (→ references/gates.md)
...
- **`gates.md`** — the gate stack: build-checks' 37 groups, the five journey drivers, the pixel gate, the morph gates, and what each one states it CANNOT reach. Read before adding or changing a gate, or before trusting a green run.
