...
import/                       the design-import core (epic #295) — Node-only, no portal, no SDK, no page
  ...
  fixtures/figma/             S5's verbatim house-plugin export + its expected verdict
  regen-expected.mjs          regenerates the committed verdicts (both converters' fixtures) — a NEW SPEC moves them (see below)
