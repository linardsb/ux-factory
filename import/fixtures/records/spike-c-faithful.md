**Import record — spike-c-faithful**
...
Worst region: `subtitle` at ΔE 0.8716 (ink-colour, CIEDE2000) against a threshold of 5.0; 7 regions scored.
...
- candidate sha256: `fba86d50576bbecc32399409cb94bb1523f8db79f1fd763bb62060db20eed9ca` — a hand-authored harness DOM with M1's two roles set from the pack (S3 capture.txt), not a render of this record's IR through its mapping
...
- attribution: Drawn in Brilliant's web editor under its default design system (spike C, 2026-08-27)
