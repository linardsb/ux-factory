...
// The COMMITTED PHOSPHOR SUBSET (#305) — a frozen name → path-data map, generated by
// agent-layer/gen-icons.mjs from system/icons.manifest.json. The `icon` template reads this and
// nothing else: no icon library ships, and the package the artwork came from is a build-time tool
// dir (tooling/icons/) no page can reach. Node-safe by construction — a frozen object literal
