...
Enough theory. You know WHY to use VSA ([Article 2](./architecture-patterns.md)). You know WHAT tooling you need ([Article 1](./codebase-search-and-lsp.md)). Now let's BUILD.
...
This article answers these questions with concrete examples. You already know [why Vertical Slice Architecture wins for AI coding](./architecture-patterns.md). If you're jumping in here, read that first—it's worth it. Now let's build one.
