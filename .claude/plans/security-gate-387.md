...
**This table is empty, deliberately.** The Sonar version of this ticket had four blocking owner prerequisites — an account, a project, a repository secret, a quality gate. CodeQL has none: free on a public repo, native to Actions, no credential this machine does not already hold. Every task in this plan can be run without waiting on anyone.
